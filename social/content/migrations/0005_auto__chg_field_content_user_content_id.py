...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Content.user_content_id'
        db.alter_column(u'content_content', 'user_content_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Content.user_content_id'
        db.alter_column(u'content_content', 'user_content_id', self.gf('django.db.models.fields.IntegerField')(default=-1))
