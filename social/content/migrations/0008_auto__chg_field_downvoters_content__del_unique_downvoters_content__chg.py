...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Content', fields ['user']
        db.delete_unique(u'content_content', ['user_id'])

        # Removing unique constraint on 'Tag', fields ['content']
        db.delete_unique(u'content_tag', ['content_id'])

        # Removing unique constraint on 'Upvoters', fields ['user']
        db.delete_unique(u'content_upvoters', ['user_id'])

        # Removing unique constraint on 'Upvoters', fields ['content']
        db.delete_unique(u'content_upvoters', ['content_id'])

        # Removing unique constraint on 'Downvoters', fields ['user']
        db.delete_unique(u'content_downvoters', ['user_id'])
        ...
        # Changing field 'Downvoters.user'
        db.alter_column(u'content_downvoters', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        ...
        # Changing field 'Upvoters.user'
        db.alter_column(u'content_upvoters', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        ...
        # Changing field 'Content.user'
        db.alter_column(u'content_content', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Downvoters.user'
        db.alter_column(u'content_downvoters', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding unique constraint on 'Downvoters', fields ['user']
        db.create_unique(u'content_downvoters', ['user_id'])
        ...
        # Changing field 'Upvoters.user'
        db.alter_column(u'content_upvoters', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding unique constraint on 'Upvoters', fields ['user']
        db.create_unique(u'content_upvoters', ['user_id'])
        ...
        # Changing field 'Content.user'
        db.alter_column(u'content_content', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding unique constraint on 'Content', fields ['user']
        db.create_unique(u'content_content', ['user_id'])
