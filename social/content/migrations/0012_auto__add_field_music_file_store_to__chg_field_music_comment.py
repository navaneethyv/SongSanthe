...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Music.file_store_to'
        db.add_column(u'content_music', 'file_store_to',
                      self.gf('django.db.models.fields.files.FileField')(default='/dev/null', max_length=100),
                      keep_default=False)


        # Changing field 'Music.comment'
        db.alter_column(u'content_music', 'comment', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Music.file_store_to'
        db.delete_column(u'content_music', 'file_store_to')


        # Changing field 'Music.comment'
        db.alter_column(u'content_music', 'comment', self.gf('django.db.models.fields.TextField')(default='No Comments!'))
    ...
    models = {
        ...
        u'content.music': {
            ...
            'content': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['content.Content']", 'unique': 'True'}),
            'file_store_to': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
